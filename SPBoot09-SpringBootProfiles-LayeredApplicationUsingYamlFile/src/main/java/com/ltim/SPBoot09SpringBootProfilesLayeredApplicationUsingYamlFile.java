...
public class SPBoot09SpringBootProfilesLayeredApplicationUsingYamlFile {
	...
	public static void main(String[] args) {
		...
		SpringApplication app = new SpringApplication(SPBoot09SpringBootProfilesLayeredApplicationUsingYamlFile.class);
