...
public class SPBoot10SpringBootProfilesLayeredApplicationUsingSingleYamlFile {
	...
	public static void main(String[] args) {
		...
		SpringApplication app = new SpringApplication(SPBoot10SpringBootProfilesLayeredApplicationUsingSingleYamlFile.class);
